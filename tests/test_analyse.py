...
from src.models.containers import ClassifierDetails, PretrainedClassifier, ImageSource
...
class TestAnalyse(unittest.TestCase):
    ...
    def dummy_classifier_details():
        return ClassifierDetails(
            ...
            image_sources=[ImageSource.STANFORD]
        )
    ...
    def test_load_inexistent_path(self):
        dummy_classifier = TestAnalyse.dummy_classifier_details()
        with self.assertRaises(FileNotFoundError):
    ...
    def test_load_inexistient_classifier(self):
        dummy_classifier = TestAnalyse.dummy_classifier_details()
        file_path = join(TEST_DATA_PATH, "collie.jpg")
        with self.assertRaises(FileNotFoundError):
            analyse_image(image_path=file_path, classifier_details=dummy_classifier)
